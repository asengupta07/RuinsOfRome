...
export default function ConvexFunctionTester() {
  ...
  const lastUserLog = useQuery(api.game.getLastUserLogs, {
    gameId,
    ...
    <div className="flex flex-col items-center gap-6 p-6">
      <Card className="w-full max-w-md">
        <CardContent className="p-6 flex flex-col gap-4">
          ...
          />
          <Button onClick={() => handleSendLog()} className="mt-2">
            Send Log
          </Button>
        </CardContent>
      </Card>
      ...
      <Card className="w-full max-w-md">
        <CardContent className="p-6 flex flex-col gap-4">
          ...
          <div className="border p-2 rounded bg-gray-100 min-h-[100px]">
