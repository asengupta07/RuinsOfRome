...
export default function GladiatorOnboarding() {
    ...
    return (
        <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#0b060a]">
            ...
            <div className={`relative z-10 w-full max-w-md px-6 py-12 transition-all duration-1000 ease-out ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}>
                ...
                <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
                    <div className="bg-stone-900/90 border-2 border-teal-700 rounded-lg p-8 max-w-md text-center animate-scaleIn">
                        ...
                        <p className="text-teal-100 text-lg mb-6">
                            To forge your champion and enter the Colosseum, you must first connect your wallet.
                        </p>
            ...
            <style jsx global>{`
                ...
                @keyframes glow {
                    0%, 100% { text-shadow: 0 0 5px rgba(20, 184, 166, 0.5); }
                ...
                @keyframes ping-slow {
                    ...
                    70%, 100% { transform: translate(-50%, -50%) scale(1.3); opacity: 0; }
                }
